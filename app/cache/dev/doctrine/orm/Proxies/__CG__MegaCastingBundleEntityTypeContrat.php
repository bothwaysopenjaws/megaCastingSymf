 ...
 */
class TypeContrat extends \MegaCastingBundle\Entity\TypeContrat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MegaCastingBundle\\Entity\\TypeContrat' . "\0" . 'id', '' . "\0" . 'MegaCastingBundle\\Entity\\TypeContrat' . "\0" . 'libelle', '' . "\0" . 'MegaCastingBundle\\Entity\\TypeContrat' . "\0" . 'offres');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TypeContrat $proxy) {
