 ...
 */
class Metier extends \MegaCastingBundle\Entity\Metier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MegaCastingBundle\\Entity\\Metier' . "\0" . 'id', '' . "\0" . 'MegaCastingBundle\\Entity\\Metier' . "\0" . 'libelle', '' . "\0" . 'MegaCastingBundle\\Entity\\Metier' . "\0" . 'description', '' . "\0" . 'MegaCastingBundle\\Entity\\Metier' . "\0" . 'utilisateurs', '' . "\0" . 'MegaCastingBundle\\Entity\\Metier' . "\0" . 'domaine', '' . "\0" . 'MegaCastingBundle\\Entity\\Metier' . "\0" . 'offres');
        }
