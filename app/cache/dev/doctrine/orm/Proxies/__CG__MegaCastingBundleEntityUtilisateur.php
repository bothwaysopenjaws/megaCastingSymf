 ...
 */
class Utilisateur extends \MegaCastingBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'dateNaissance', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'historiques', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'adresse', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'competences', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'multimedias', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'abonnements', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'offres', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'telephone', '' . "\0" . 'MegaCastingBundle\\Entity\\Utilisateur' . "\0" . 'typeUtilisateur', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function setTypeUtilisateur(\MegaCastingBundle\Entity\TypeUtilisateur $typeUtilisateur)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeUtilisateur', array($typeUtilisateur));
    ...
    public function getTypeUtilisateur()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeUtilisateur', array());
    ...
    public function addHistorique(\MegaCastingBundle\Entity\Historique $historiques)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addHistorique', array($historiques));

        return parent::addHistorique($historiques);
    }
    ...
    public function removeHistorique(\MegaCastingBundle\Entity\Historique $historiques)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeHistorique', array($historiques));

        return parent::removeHistorique($historiques);
    }
    ...
    public function getHistoriques()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHistoriques', array());
    ...
    public function addMultimedia(\MegaCastingBundle\Entity\Multimedia $multimedias)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addMultimedia', array($multimedias));

        return parent::addMultimedia($multimedias);
    }
    ...
    public function removeMultimedia(\MegaCastingBundle\Entity\Multimedia $multimedias)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeMultimedia', array($multimedias));

        return parent::removeMultimedia($multimedias);
    }
    ...
    public function getMultimedias()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMultimedias', array());

        return parent::getMultimedias();
    }
