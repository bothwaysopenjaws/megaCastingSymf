 ...
 */
class Historique extends \MegaCastingBundle\Entity\Historique implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MegaCastingBundle\\Entity\\Historique' . "\0" . 'id', '' . "\0" . 'MegaCastingBundle\\Entity\\Historique' . "\0" . 'societe', '' . "\0" . 'MegaCastingBundle\\Entity\\Historique' . "\0" . 'dateDebut', '' . "\0" . 'MegaCastingBundle\\Entity\\Historique' . "\0" . 'dateFin', '' . "\0" . 'MegaCastingBundle\\Entity\\Historique' . "\0" . 'description', '' . "\0" . 'MegaCastingBundle\\Entity\\Historique' . "\0" . 'utilisateur');
        }
