 ...
 */
class Niveau extends \MegaCastingBundle\Entity\Niveau implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MegaCastingBundle\\Entity\\Niveau' . "\0" . 'id', '' . "\0" . 'MegaCastingBundle\\Entity\\Niveau' . "\0" . 'libelle');
        }
